...
<head>
    ...
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.0/css/bootstrap.min.css"
        ...
        <link rel="stylesheet" href="restroHome.css">
</head>
...
<body>
    ...
    <div class="container">
                ...
                while ($row = mysqli_fetch_assoc($result)):
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            ...
                            <a href="../server/restro.php?delete=<?php echo $row['id']; ?>" class='btn btn-danger'>Delete
                            </a>
                        </td>
                    </tr>
                <?php endwhile; ?>
        ...
        <!-- form to add new menu item -->
        <div class="row justify-content-center">
            <div class="shadow p-3 mb-5 bg-white rounded w-50 bordered-form">
                <div class="header row justify-content-center">
                    <h2>Item details:</h2>
                </div>
                <form action="../server/restro.php" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="itemname" value="<?php echo $currentItemName; ?>"
                            required>
                    </div>
                    <div class="form-group">
                        <label for="item cost">item cost: </label>
                        <input type="number" name="itemcost" class="form-control"
                            value="<?php echo $currentItemCost; ?>" required>
                    </div>
                    <div class="form-group">
                        <label for="item details">item description: </label>
                        <textarea name="itemdetail" class="form-control" rows="4"
                            maxlength="1000"><?php echo $currentItemDetail; ?></textarea>
                    </div>
                    <div class="form-group">
                        <label for="item type">Item Type: </label>
                        <input type="radio" name="type" value="veg" <?php if ($currentItemType == 'veg')
                            echo "checked"; ?>>veg
                        <input type="radio" name="type" value="non veg" <?php if ($currentItemType == 'non veg')
                            echo "checked"; ?>>non-veg
                    </div>
                    <div class="form-group">
                        <?php if ($update): ?>
